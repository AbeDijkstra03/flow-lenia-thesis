...
def main():
    ...
    parser.add_argument("--scale_steps", type=int, default=10000, help="Scaled-up simulation steps horizon (e.g. 10000)")
    parser.add_argument("--sample_interval", type=int, default=250, help="Frame sampling interval")
