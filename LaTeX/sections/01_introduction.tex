...
\label{subsec:intro_code_reproducibility}

To support open science, computational transparency, and full empirical reproducibility, the complete JAX simulation engine, IMGEP discovery algorithms, experimental execution scripts, and visualization suites are publicly available on GitHub at \url{https://github.com/AbeDijkstra03/flow-lenia-thesis}. Step-by-step CLI reproduction instructions and hardware dependencies are detailed in \Cref{sec:appendix_reproducibility}.
