...
The complete source code, configuration files, test suites, and empirical data artifacts developed for this thesis are openly available on GitHub at \url{https://github.com/AbeDijkstra03/flow-lenia-thesis}.
...
Every figure, table, and data artifact in this thesis can be reproduced directly using the unified CLI orchestrator (\texttt{run\_experiment.py}) provided in the GitHub repository (\url{https://github.com/AbeDijkstra03/flow-lenia-thesis}):
